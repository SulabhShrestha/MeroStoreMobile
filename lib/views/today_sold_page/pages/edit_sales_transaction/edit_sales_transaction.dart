...
class EditSalesTransaction extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EditSalesTransaction> createState() =>
      _EditSalesTransactionState();
}

class _EditSalesTransactionState extends ConsumerState<EditSalesTransaction> {
  ...
  List<dynamic> _allBroughtQuantities = [];
  ...
  void initState() {
    // Transaction types
    _currentTransactionType = widget.salesModel.transactionType;

    _currentStoreName = widget.salesModel.storeModel.storeName;

    // Transaction types
    _allTransactionTypes = widget.salesModel.storeModel.transactionTypes;
    ...
    _allBroughtQuantities = widget.salesModel.storeModel.quantityTypes;
    ...
    for (Map elem in allFormFields) {
      ...
      if (controllers.containsKey(heading)) {
        controllers[heading] = TextEditingController(
            text: (widget.salesModel.details[elem["fieldName"]] ?? "")
                .toString());
      }
    }

    _currentQuantityType = widget.salesModel.details["soldQuantityType"];
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    CustomDropDownBtn(
                      options: [widget.salesModel.storeModel.storeName],
                ...
                Row(
                  children: [
                    ...
                    CustomDropDownBtn(
                      ...
                      initialValue: widget.salesModel.transactionType,
                      onTap: (value) {
          ...
          children: [
            ...
            if (elem["quantityOption"] != null)
              DottedUnderlineTextFieldWithDropDownBtn(
                ...
                keyboardType: elem["keyboardType"] ?? TextInputType.text,
                quantityTypes: widget.salesModel.storeModel.quantityTypes,
